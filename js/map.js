...
function ready(error, world, ports, paths, ports_data, paths_data) {
	...
	hoverbox.append("text").attr("class", "shipnames").attr("id", "ship1").attr("x", 10).attr("y", 145).text("Name");
	hoverbox.append("text").attr("class", "shipnames").attr("id", "ship2").attr("x", 10).attr("y", 165).text("Name");
	hoverbox.append("text").attr("class", "shipnames").attr("id", "ship3").attr("x", 10).attr("y", 185).text("Name");
	
	hoverbox.append("text").attr("class", "shipnames").attr("id", "comm1").attr("x", 150).attr("y", 145).text("Name");
	hoverbox.append("text").attr("class", "shipnames").attr("id", "comm2").attr("x", 150).attr("y", 165).text("Name");
	hoverbox.append("text").attr("class", "shipnames").attr("id", "comm3").attr("x", 150).attr("y", 185).text("Name");
